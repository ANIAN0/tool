...
import { MessageSquarePlus, PanelLeftClose, BotIcon, Pencil, Trash2 } from "lucide-react";
...
function ConversationItem({
  ...
  return (
    <div
      className={`
        group flex flex-col gap-0.5 rounded-md px-3 py-2 cursor-pointer
    ...
    >
      ...
      {conversation.total_tokens > 0 && (
        <div className="flex items-center gap-1 text-[10px] text-muted-foreground ml-6">
