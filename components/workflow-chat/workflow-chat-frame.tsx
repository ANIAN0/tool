...
/**
 * WorkflowChat 外层容器布局组件
 * 极简布局：侧边栏作为安静的工具，主对话区占据视觉主导
 * 完全复制 AgentChatFrame 的组合模式
 */
 ...
 * - 布局流畅，给予内容区最大空间
 */
export function WorkflowChatFrame({ children }: { children: React.ReactNode }) {
  // 从 Context 获取状态和操作
