---
description: Real-time search engine supporting web search, vertical domain search, parallel batch search, and URL content extraction. Optional API key ANYSEARCH_API_KEY for higher rate limits.
---
